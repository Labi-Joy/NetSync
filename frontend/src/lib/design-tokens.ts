// NetSync Design System Tokens
export const designTokens = {
  // Color System - Purple Theme Only
  colors: {
    // Primary Colors
    primary: {
      50: '#faf5ff',
  ...
  boxShadow: {
    ...
    // Purple shadows for special elements
    purple: '0 10px 25px -5px rgb(168 85 247 / 0.3), 0 8px 10px -6px rgb(168 85 247 / 0.1)',
    'purple-lg': '0 20px 40px -10px rgb(168 85 247 / 0.4), 0 8px 16px -6px rgb(168 85 247 / 0.2)',
  },
...
export const componentVariants = {
  ...
  input: {
    ...
    variant: {
      ...
      success: 'border border-green-500 focus:border-green-500 focus:ring-green-500',
    },
  },
